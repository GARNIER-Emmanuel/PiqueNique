<article id="AjoutEtudiant">
        <h1><img src="images/ico_epingle.png" alt="Intégration" class="ico_categorie" />Enregistrement d'un nouvel étudiant</h1>
        <form action='index.php?controleur=etudiants&action=enregistrer' method='POST'>        
            <table>
            <tr><th>Nom </th>         <td> <input type='text' name='nom'/> </td>
            </tr>
            <tr> <th>Prénom </th>      <td> <input type='text' name='prenom'/> </td>
            </tr>
            <tr> <th>Classe (1: SIO1; 2 : SIO2)</th>  <td><input type='number' name='idC'/> </td>
            </tr>
